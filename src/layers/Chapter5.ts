class Chapter5 extends Layers {
    ...
    public show(callback: Function, thisObject: egret.DisplayObjectContainer) {
        ...
        let p2: egret.Bitmap = this.createBitmapByName("5_2_jpg");
        this.animation(p2, 1000);
        p2.width = stageW;
        p2.height = stageH;

        let p3: egret.Bitmap = this.createBitmapByName("5_3_jpg");
        p3.width = stageW;
        p3.x = stageW;
        this.animation1(p3, 2300);

        let p4: egret.Bitmap = this.createBitmapByName("5_4_jpg");
        p4.width = stageW;
    ...
    private eat() {
        console.log("eat!")
        let p6: egret.Bitmap = this.createBitmapByName("5_6_png");
        p6.width = 720;
        p6.y = 950;
        this.animation2(p6, 0);

        let p7: egret.Bitmap = this.createBitmapByName("5_7_png");
        p7.width = 720;
        p7.y = 800;
        this.animation2(p7, 1300);

        let p8: egret.Bitmap = this.createBitmapByName("5_8_png");
        p8.width = 720;
        p8.y = 750;
        this.animation2(p8, 2300);

        let person: egret.Bitmap = this.createBitmapByName("5_9_jpg");
        person.width = 720;
        this.animation2(person, 3600);

        let h1: egret.Bitmap = this.createBitmapByName("h1_png");
        h1.x = 280;
        h1.y = 655;
    ...
    private progress1() {
        this.chew();
        let h2: egret.Bitmap = this.createBitmapByName("h2_png");
        h2.x = 280;
        h2.y = 655;
        this.addChild(h2)
    ...
    private progress2() {
        this.chew();
        let h2: egret.Bitmap = this.createBitmapByName("h3_png");
        h2.x = 280;
        h2.y = 655;
        this.addChild(h2)
        this.createTween(h2)
    ...
    private progress3() {
        this.chew();
        let h2: egret.Bitmap = this.createBitmapByName("h4_png");
        h2.x = 280;
        h2.y = 655;
        this.addChild(h2)
        this.createTween(h2)
    ...
    private progress4() {
        this.chew();
        let h2: egret.Bitmap = this.createBitmapByName("m1_png");
        h2.x = 310;
        h2.y = 585;
        this.addChild(h2)
        this.createTween(h2)
    ...
    private progress5() {
        this.drink()
        let h2: egret.Bitmap = this.createBitmapByName("m2_png");
        h2.x = 310;
        h2.y = 585;
        this.addChild(h2)
        this.createTween(h2)
    ...
    private progress6() {
        this.drink()
        let c1: egret.Bitmap = this.createBitmapByName("5_10_jpg");
        c1.width = 720;
        this.animation3(c1, 0);
        let c2: egret.Bitmap = this.createBitmapByName("5_9_jpg");
        c2.width = 720;
        this.animation3(c2, 550);
        let h2: egret.Bitmap = this.createBitmapByName("m3_png");
        h2.width = 125;
        h2.x = 310;
        h2.y = 585;
        this.addChild(h2)
    ...
    private progress7() {
        let p1: egret.Bitmap = this.createBitmapByName("5_11_jpg");
        p1.width = 720;
        p1.x = 720;
        this.animation1(p1, 0);

        let p2: egret.Bitmap = this.createBitmapByName("5_12_jpg");
        p2.width = 720;
        this.animation2(p2, 1500);

        let p3: egret.Bitmap = this.createBitmapByName("5_13_jpg");
        p3.width = 720;
        this.animation2(p3, 2500);

        let p4: egret.Bitmap = this.createBitmapByName("5_14_jpg");
        p4.width = 720;
        this.animation2(p4, 3500);

        let p5: egret.Bitmap = this.createBitmapByName("5_15_jpg");
        p5.width = 720;
        this.animation2(p5, 4500);
        this.animation5(p5, 6000);

        let p6: egret.Bitmap = this.createBitmapByName("5_16_jpg");
        p6.width = 720;
    ...
    private progress9() {
        let p1: egret.Bitmap = this.createBitmapByName("5_17_jpg");
        p1.width = 720;
    ...
    private progress10() {
        let p1: egret.Bitmap = this.createBitmapByName("5_18_jpg");
        p1.width = 720;
        this.animation2(p1, 0);
        this.math();
    ...
    private middle() {
        let p1: egret.Bitmap = this.createBitmapByName("5_19_jpg");
        p1.width = 900;
        p1.x = -100;
        p1.y = -250;
        p1.height = 1836;
        ...
        let p2: egret.Bitmap = this.createBitmapByName("5_20_jpg");
        p2.width = 720;
        this.animation2(p2, 2500);

        let p3: egret.Bitmap = this.createBitmapByName("5_21_jpg");
        p3.width = 720;
        this.animation2(p3, 4000);

        let p4: egret.Bitmap = this.createBitmapByName("5_22_jpg");
        p4.width = 720;
    ...
    private end() {
        let p1: egret.Bitmap = this.createBitmapByName("5_24_jpg");
        p1.width = 720;
        this.animation2(p1, 500);

        let p2: egret.Bitmap = this.createBitmapByName("5_25_jpg");
        p2.width = 720;
        this.animation2(p2, 2000);

        let p3: egret.Bitmap = this.createBitmapByName("5_26_jpg");
        p3.width = 720;
        this.animation2(p3, 3300);

        let p4: egret.Bitmap = this.createBitmapByName("5_27_jpg");
        p4.width = 720;
    ...
    private math() {
        this.p1 = this.createBitmapByName("add_png");
        this.p1.x = 110;
        this.p1.y = 985;
        this.addChild(this.p1)

        this.p2 = this.createBitmapByName("subtract_png");
        this.p2.x = 240;
        this.p2.y = 985;
        this.addChild(this.p2)

        this.p3 = this.createBitmapByName("multiply_png");
        this.p3.x = 370;
        this.p3.y = 985;
        this.addChild(this.p3)

        this.p4 = this.createBitmapByName("divide_png");
        this.p4.x = 500;
        this.p4.y = 985;
    ...
    private chew() {
        ...
        sound.addEventListener(egret.Event.COMPLETE, this.onLoadComplete, this);
        sound.load(url);
        let c1: egret.Bitmap = this.createBitmapByName("5_10_1jpg");
        c1.width = 720;
        this.animation3(c1, 0);
        let c2: egret.Bitmap = this.createBitmapByName("5_10_2jpg");
        c2.width = 720;
        this.animation3(c2, 350);
        let c3: egret.Bitmap = this.createBitmapByName("5_10_3jpg");
        c3.width = 720;
        this.animation3(c3, 700);
        let c4: egret.Bitmap = this.createBitmapByName("5_10_4jpg");
        c4.width = 720;
        this.animation3(c4, 1050);
        let c5: egret.Bitmap = this.createBitmapByName("5_10_5jpg");
        c5.width = 720;
        this.animation3(c5, 1400);
        let c6: egret.Bitmap = this.createBitmapByName("5_10_6jpg");
        c6.width = 720;
        this.animation3(c6, 1750);
        let c7: egret.Bitmap = this.createBitmapByName("5_10_7jpg");
        c7.width = 720;
        this.animation3(c7, 2100);
        let c8: egret.Bitmap = this.createBitmapByName("5_10_8jpg");
        c8.width = 720;
        this.animation3(c8, 2450);
        let c9: egret.Bitmap = this.createBitmapByName("5_9_jpg");
        c9.width = 720;
