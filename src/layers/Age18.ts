class Age18 extends Layers {
    ...
    public show(callback: Function, thisObject: egret.DisplayObjectContainer) {
        let p1 = this.getBitMapByName("7_1_jpg");
        this.addChild(p1);
        ...
        let p2: egret.Bitmap = this.getBitMapByName("7_2_jpg");
        this.animation2(p2, 1000);
        p2.width = stageW;
        p2.height = stageH;
        this.animation3(p2, 2300);

        let p3: egret.Bitmap = this.getBitMapByName("7_3_jpg");
        p3.width = stageW;
        p3.x = stageW;
        this.animation1(p3, 2300);

        let p4: egret.Bitmap = this.getBitMapByName("7_4_jpg");
        p4.width = stageW;
    ...
    private progress1() {
        let p1: egret.Bitmap = this.getBitMapByName("7_7_jpg");
        this.animation2(p1, 1000);
        let p2: egret.Bitmap = this.getBitMapByName("7_12_png");
        let p3: egret.Bitmap = this.getBitMapByName("7_10_png");
        let p4: egret.Bitmap = this.getBitMapByName("7_8_png");
        p4.x = 0;
        p4.y = 600
        let p5: egret.Bitmap = this.getBitMapByName("7_9_png");
        p5.x = 310;
        p5.y = 480;
        let p6: egret.Bitmap = this.getBitMapByName("7_11_png");
    ...
    private progress2() {
        let p1: egret.Bitmap = this.getBitMapByName("7_13_jpg");
        p1.width = 720;
        p1.height = 1280
        p1.x = 720;
        this.animation1(p1, 2000);
        let p3: egret.Bitmap = this.getBitMapByName("a_1");
        p3.width = 720;
        p3.height = 1280
        p3.x = 720;
        this.animation1(p3, 2000);
        let p4: egret.Bitmap = this.getBitMapByName("a_2");
        let p5: egret.Bitmap = this.getBitMapByName("a_3");
        ...
        this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function up() {
            ...
            this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function up1() {
                ...
                this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function up2() {
                    ...
                    let p2: egret.Bitmap = this.getBitMapByName("7_13_1png");
                    p2.width = 720;
                    p2.height = 1280;
                    this.addChild(p2);
    ...
    private progress3() {
        let p1: egret.Bitmap = this.getBitMapByName("7_14_jpg");
        p1.width = 720;
        p1.height = 1280
        this.animation2(p1, 1000);
        let p3: egret.Bitmap = this.getBitMapByName("a_1");
        ...
        this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function up() {
            ...
            this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function up1() {
                ...
                this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function up2() {
                    this.animation4(p5, 500)
                    let p2: egret.Bitmap = this.getBitMapByName("7_14_1png");
                    p2.width = 720;
                    p2.height = 1280;
                    this.addChild(p2);
                    this.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, up2, this)
    ...
    private progress4() {
        let p1: egret.Bitmap = this.getBitMapByName("7_15_jpg");
        p1.width = 720;
        p1.height = 1280
        this.animation2(p1, 1000);
        let p3: egret.Bitmap = this.getBitMapByName("a_1");
        ...
        this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function up() {
            ...
            this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function up1() {
                ...
                this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function up2() {
                    this.animation4(p5, 500)
                    let p2: egret.Bitmap = this.getBitMapByName("7_15_1png");
                    p2.width = 720;
                    p2.height = 1280;
                    this.addChild(p2);
                    this.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, up2, this)
    ...
    private progress5() {
        let p1: egret.Bitmap = this.getBitMapByName("7_16_jpg");
        p1.width = 720;
        p1.height = 1280
        this.animation2(p1, 1000);
    ...
    private p() {
        ...
        if (this.number >= 2) {
            console.log('1')
            let p1: egret.Bitmap = this.getBitMapByName("g_1");
            p1.width = 720;
            this.animation2(p1, 500);
            let p2: egret.Bitmap = this.getBitMapByName("g_2");
            p2.width = 720
            this.animation2(p2, 1000);
            let p3: egret.Bitmap = this.getBitMapByName("b_1");
            p3.width = 720;
            ...
            let p2: egret.Bitmap = this.getBitMapByName("b_1");
            p2.width = 720;
            p2.y = -100;
            this.animation2(p2, 500);
            let p3: egret.Bitmap = this.getBitMapByName("b_2");
            p3.width = 720;
            p3.y = -100;
            this.animation2(p3, 1000);
        }
    ...
    private p1(){
        ...
        if (this.number1 >= 2) {
            console.log('2')
            let p1: egret.Bitmap = this.getBitMapByName("g_5");
            p1.y = -450;
            p1.width = 720;
            this.animation2(p1, 500);
            let p2: egret.Bitmap = this.getBitMapByName("g_3");
            p2.width = 720
            this.animation2(p2, 1000);
            let p3: egret.Bitmap = this.getBitMapByName("b_3");
            p3.width = 720;
            this.animation2(p3, 2000);
        }
        else {
            let p1: egret.Bitmap = this.getBitMapByName("g_3");
            p1.width = 720;
            p1.y = -100;
            this.animation2(p1, 0);
            let p2: egret.Bitmap = this.getBitMapByName("b_6");
            p2.y = -450;
            p2.width = 720;
            this.animation2(p2, 1000);
            let p3: egret.Bitmap = this.getBitMapByName("b_3");
        ...
        event1 = ()=>{
            ...
            .call(() => {
                if(this.number2>0){
                    if (this.number2 >= 2) {
                        let p1: egret.Bitmap = this.getBitMapByName("g_6");
                        p1.y = -140;
                        p1.width = 720;
                        this.animation2(p1, 500);
                        let p2: egret.Bitmap = this.getBitMapByName("g_4");
                        p2.y = -40
                        p2.width = 720
                        this.animation2(p2, 1000);
                        let p3: egret.Bitmap = this.getBitMapByName("b_5");
                        p3.y = -70
                        p3.width = 720;
                        this.animation2(p3, 2000);
                        this.progress6()
                        ...
                        let p4: egret.Bitmap = this.getBitMapByName("g_4");
                        p4.y = -140;
                        p4.width = 720;
                        this.animation2(p4, 500);
                        let p5: egret.Bitmap = this.getBitMapByName("b_4");
                        p5.width = 720;
                        p5.y = 80;
                        this.animation2(p5, 1000);
                        let p6: egret.Bitmap = this.getBitMapByName("b_5");
                        p6.y = -50
                        p6.width = 720;
                        this.animation2(p6, 1500);
                        this.progress6()
                    }
                }
                else{
    ...
    private progress6() {
        let p1: egret.Bitmap = this.getBitMapByName("7_17_jpg");
        p1.width = 720;
        p1.height = 1280
        this.animation2(p1, 3500);
        let p2: egret.Bitmap = this.getBitMapByName("7_18_jpg");
        p2.width = 720;
        p2.height = 1280
        this.animation2(p2, 4500);
        let p3: egret.Bitmap = this.getBitMapByName("7_19_jpg");
        p3.width = 720;
        p3.height = 1280
    ...
    private progress7() {
        let p1: egret.Bitmap = this.getBitMapByName("7_29_jpg");
        p1.x = 720;
        p1.width = 720;
        p1.height = 1280
        ...
        event = (e: egret.TouchEvent) => {
            if (this.inArea(e.stageX, e.stageY, 80, 500, 280, 250)) {
                let p2: egret.Bitmap = this.getBitMapByName("7_30_jpg");
                p2.width = 720;
                p2.height = 1280
                this.animation2(p2, 500);
                let p3: egret.Bitmap = this.getBitMapByName("7_31_jpg");
                p3.width = 720;
                p3.height = 1280
    ...
    private progress8() {
        this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function chat() {
            let p2: egret.Bitmap = this.getBitMapByName("7_32_jpg");
            p2.width = 720;
            p2.height = 1280
            this.animation2(p2, 500);
            let p1: egret.Bitmap = this.getBitMapByName("i_1");
            p1.width = 720;
            p1.height = 1280
            this.animation2(p1, 500);
            ...
            this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function chat1() {
                ...
                let p2: egret.Bitmap = this.getBitMapByName("7_33_jpg");
                p2.width = 720;
                p2.height = 1280
                this.animation2(p2, 500);
                let p1: egret.Bitmap = this.getBitMapByName("i_1");
                ...
                p1.height = 1280
                this.animation2(p1, 500);
                let p3: egret.Bitmap = this.getBitMapByName("7_34_jpg");
                p3.width = 720;
                p3.height = 1280
                this.animation2(p3, 2000);
                let p4: egret.Bitmap = this.getBitMapByName("7_35_png");
                p4.x = 170;
                p4.y = -150;
                p4.width = 350;
    ...
    private progress9() {
        ...
        event = (e: egret.TouchEvent) => {
            if (this.inArea(e.stageX, e.stageY, 170, 0, 300, 100)) {
                let p2: egret.Bitmap = this.getBitMapByName("7_36_jpg");
                p2.width = 720;
                p2.height = 1280
                this.animation2(p2, 500);
                this.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, event, this)
                this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function chat() {
                    let p2: egret.Bitmap = this.getBitMapByName("7_37_png");
                    p2.width = 720;
                    p2.height = 1280
                    this.animation2(p2, 500);
                    let p1: egret.Bitmap = this.getBitMapByName("7_38_png");
                    p1.width = 720;
                    p1.height = 1280
                    this.animation2(p1, 2000);
                    this.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, chat, this)
                    this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function chat1() {
                        let p2: egret.Bitmap = this.getBitMapByName("7_39_png");
                        p2.width = 720;
                        p2.height = 1280
                        this.animation2(p2, 500);
                        let p1: egret.Bitmap = this.getBitMapByName("7_40_png");
                        p1.width = 720;
                        p1.height = 1280
                        this.animation2(p1, 2000);
                        this.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, chat1, this)
                        let p3: egret.Bitmap = this.getBitMapByName("7_41_jpg");
                        p3.width = 720;
                        p3.height = 1280
                        this.animation2(p3, 3500);
                        let p4: egret.Bitmap = this.getBitMapByName("7_42_jpg");
                        p4.width = 720;
                        p4.height = 1280
                        this.animation2(p4, 5000);
                        let p5: egret.Bitmap = this.getBitMapByName("7_43_jpg");
                        p5.width = 720;
                        p5.height = 1280
    ...
    private electrocardiogram() {
        let p4: egret.Bitmap = this.getBitMapByName("7_20_jpg");
        p4.width = 720;
        p4.height = 1280
        this.animation2(p4, 0);
        let p5: egret.Bitmap = this.getBitMapByName("7_21_jpg");
        p5.width = 720;
        p5.height = 1280
        this.animation2(p5, 700);
        let p6: egret.Bitmap = this.getBitMapByName("7_22_jpg");
        p6.width = 720;
        p6.height = 1280
    ...
    private electrocardiogram1() {
        let p7: egret.Bitmap = this.getBitMapByName("7_23_jpg");
        p7.width = 720;
        p7.height = 1280
        this.animation2(p7, 0);
        let p8: egret.Bitmap = this.getBitMapByName("7_24_jpg");
        p8.width = 720;
        p8.height = 1280
        this.animation2(p8, 700);
        let p9: egret.Bitmap = this.getBitMapByName("7_25_jpg");
        p9.width = 720;
        p9.height = 1280
    ...
    private electrocardiogram2() {
        let p10: egret.Bitmap = this.getBitMapByName("7_26_jpg");
        p10.width = 720;
        p10.height = 1280
        this.animation2(p10, 0);
        let p11: egret.Bitmap = this.getBitMapByName("7_27_jpg");
        p11.width = 720;
        p11.height = 1280
        this.animation2(p11, 700);
        let p12: egret.Bitmap = this.getBitMapByName("7_28_jpg");
        p12.width = 720;
        p12.height = 1280
    ...
    private hair() {
        let p1: egret.Bitmap = this.getBitMapByName("7_5_jpg");
        p1.alpha = 1;
        let p2: egret.Bitmap = this.getBitMapByName("7_6_jpg");
        p2.alpha = 0;
        let hair1 = egret.Tween.get(p1, {
            loop: true,
        })
        let hair2 = egret.Tween.get(p2, {
            loop: true,
        })

        hair1.to({"alpha":0},400)
        hair1.wait(400);
        hair1.to({"alpha":1},400)
        hair1.wait(400);

        hair2.to({"alpha":1},400)
        hair2.wait(400);
        hair2.to({"alpha":0},400)
        hair2.wait(400);
